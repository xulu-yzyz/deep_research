...
# # 依赖附录 A 中扩展后的 app.core.research_pipeline
...
#         data = asyncio.run(send_json_message(q_base, {"topic": t, "domain": d}))
#         if data.get("error"):
...
#     settings = get_settings()
#     port = settings.a2a_orchestrator_port
#     skill = AgentSkill(
#         id="orchestrate_deep_research",
#         name="Orchestrate deep research",
#         description="JSON: uid, topic, domain, stages, force_new, old_question_ids, tavily_api_key?",
#         tags=["orchestrator"],
#         examples=["{...}"],
#     )
#     card = AgentCard(
#         name="DeepResearch Orchestrator",
#         description="Holds DB/cache; delegates LLM to Question/Research/Report A2A agents.",
#         version="0.1.0",
